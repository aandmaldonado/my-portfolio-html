...
function getFullYear() {
    var d = new Date();
    var n = d.getFullYear();
    var footer = "© " + n + " Álvaro Maldonado. Made With Love";
...
jQuery(function ($) {
   ...
   ====================================== */
    ...
    if ($("#personal").length) {
        ...
        personal.typeString('Civil Engineer in Computer Science').pauseFor(2000).deleteAll()
            .typeString("Master's Degree in Artificial Intelligence").pauseFor(2000).deleteAll()
            .typeString('Senior Software Engineer').start();
    }
